...
@Configuration
public class PurchaseStatusDeliveredConfig {

    @Bean
    public PurchaseStatus purchaseStatusDelivered(PurchaseStatusFetcher fetcher) {
        var id = UUID.randomUUID();
        var name = "delivered";
        var description = "The status for purchase delivered by producer";
