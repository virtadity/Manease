package com.virtadity.manease.infrastructure.web.rest_controller.purchase;
...
public class TestPurchaseControllerRegister {
    @Autowired
    ...
    void testRegister() throws Exception {
        ...
        when(purchaseRegister.execute(any())).thenReturn(purchaseResponse);
        ...
        mockMvc.perform(post("/purchases").contentType(MediaType.APPLICATION_JSON).content(requestBody))
